...
class Jeu:
    ...
    def __init__(self):
        ...
        self.balle_vitesse_x, self.balle_vitesse_y = 3, 1
    ...
    def creer_message(self, font, message, message_rectangle, couleur):
        ...
        if font == 'petite':
            font = pygame.font.Font('atariClassic-gry3.ttf', 20)

        elif font == 'moyenne':
            font = pygame.font.Font('atariClassic-gry3.ttf', 30)

        elif font == 'grande':
            font = pygame.font.Font('atariClassic-gry3.ttf', 40)
